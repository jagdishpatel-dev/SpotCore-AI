            ...
            <div key={s.title} className="reveal-init scale-in" data-reveal-child>
              <Card className="group h-full p-5" interactive>
                <div className="flex items-start gap-3">
                  <span className="grid h-10 w-10 shrink-0 place-items-center rounded-xl border border-[var(--border-soft)] bg-[var(--bg-surface-2)]/60 text-text-secondary transition-colors group-hover:border-accent-cyan/40 group-hover:bg-accent-cyan/10 group-hover:text-accent-cyan">
